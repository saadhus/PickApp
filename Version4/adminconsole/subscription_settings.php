  ...
  <body>
    ...
    <div id="wrapper">
          ...
          <ul class="nav navbar-nav side-nav">
			...
			<li class="dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li class="active"><a href="subscription_settings.php"><i class="fa fa-wrench"></i> Subscription Settings</a></li>
              </ul>
            </li>
      ...
      <div id="page-wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h1>Subscription Settings <small>change your subscription or mailing lists settings</small></h1>
            <ol class="breadcrumb">
              <li><a href="dashboard.php"><i class="fa fa-dashboard"></i> Dashboard</a></li>
              <li class="active"><i class="icon-file-alt"></i> Subscription Settings</li>
            </ol>
          </div>
        </div><!-- /.row -->
					...
					<b><h3>Text "SUBSCRIBE" to $storeNumber to get added to mailing list</h3></b><br>
						...
						<div class="bs-example">
							<table class="table table-bordered">
							  ...
							  <tbody>
								<tr>
								  <td rowspan="2"><center><div contenteditable>MILLA PULL $welcomeMessage FROM DATABASE HERE!</div></center></td>
								</tr>
							  </tbody>
							</table>
						</div>
						...
						<div class="bs-example">
							<table class="table table-bordered">
							  ...
							  <tbody>
								<tr>
								  <td rowspan="2"><center><div contenteditable>MILLA PULL $goodbyeMessage FROM DATABASE HERE!</div></center></td>
								</tr>
							  </tbody>
							</table>
						</div>
