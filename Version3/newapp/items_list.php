      ...
      <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div id="page-wrapper">
			...
			<!--<div class="row2">-->
				...
				<form role="form" method="post" action="items_list.php">
					<center>
			...
			<div class="row2">
				...
				<div class="col-md-12 hero-unit">
					...
					<table id="main_table" class="table table-bordered table-hover tablesorter inventory-list">
					  ...
					  <tr>
						  <td data-cid="1"><? echo $row['id']; ?></td>
						  <td><div contenteditable data-rid="<? echo $row['id']; ?>" data-cid="2"><? echo $row['item_name']; ?></div></td>
						  <td><div contenteditable data-rid="<? echo $row['id']; ?>" data-cid="3"><? echo $row['location']; ?></div></td>
