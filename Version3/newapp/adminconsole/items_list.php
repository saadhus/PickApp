...
<html lang="en">
  ...
  <script src="js/jquery-1.11.0.min.js"></script>
        ...
        <div id="page-wrapper">
			...
			<div class="row">
			  <div class="col-lg-12">
				...
				<h1>Items List <small>Add items according to location to create a directory</small></h1>
				<ol class="breadcrumb">
				  <li><a href="dashboard.php"><i class="fa fa-dashboard"></i> Dashboard</a></li>
				  <li class="active"><i class="fa fa-table"></i> Items List</li>
				</ol>
			...
			<!--<div class="row2">-->
				...
				<form role="form" method="post" action="items_list.php?ut=1">
					<center>
				...
				<form role="form" method="post" enctype="multipart/form-data" action="items_list.php?ut=2">
					<center>
			...
			<div class="row2">
				...
				<div class="col-md-12 hero-unit">
					...
					<table id="main_table" class="table table-bordered table-hover tablesorter inventory-list">
						<thead>
						  <tr>
							<th width="48%" data-placeholder="item filter">Item <i class="fa fa-sort"></i></th>
							<th width="48%" data-placeholder="location filter" >Location <i class="fa fa-sort"></i></th>
						...
						else if ($_GET['ut']==1) // add item
						{
							...
							if(!($_FILES['csv'][size] > 0)) {
								...
								while (($data = fgetcsv($handle, 1000, ",")) !== FALSE) {
									$import="INSERT into $table_name(item_name,location) values('$data[0]','$data[1]')";
					  ...
					  <tr>
						  <td><div contenteditable class="e-row" data-rid="<? echo $row['id']; ?>" data-cid="2"><? echo $row['item_name']; ?></div></td>
						  <td><div contenteditable class="e-row" data-rid="<? echo $row['id']; ?>" data-cid="3"><? echo $row['location']; ?></div></td>
	  ...
	  <div class="modal-dialog">
		<div class="modal-content">
		  ...
		  <div class="modal-footer">
			...
			<form role="form" method="post" action="items_list.php?ut=9" style="display:inline;">
	...
	<script src="js/ajax/items_list_ajax.js"></script>
	<script>
		// Create a closure
		(function(){
			// Your base, I'm in it!
