...
<html lang="en">
  <head>
    ...
    <title>Promotions Settings</title>
  ...
  <body>
    ...
    <div id="wrapper">
          ...
          <ul class="nav navbar-nav side-nav">
			...
			<li class="dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li class="active"><a href="promotions_settings.php"><i class="fa fa-wrench"></i> Promotions Settings</a></li>
              </ul>
            </li>
			<li class="dropdown">
      ...
      <div id="page-wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h1>Promotions Settings <small>change your promotions settings</small></h1>
            <ol class="breadcrumb">
              <li><a href="dashboard.php"><i class="fa fa-dashboard"></i> Dashboard</a></li>
              <li class="active"><i class="fa fa-wrench"></i> Promotions Settings</li>
            </ol>
          </div>
        </div><!-- /.row -->
		...
		<div class="row">
			...
			<div class="col-lg-12"><h2>
				...
				<div id="blk-2" class="toHide" style="display:none">
					...
					<div class="row">
						<h3>
						<div class="col-xs-3">For each search, return the top</div>
						<div class="col-xs-2"><select class="form-control">
						  <option>1 match</option>
						  <option>2 matchs</option>
						  <option>3 matchs</option>
						  <option>4 matchs</option>
						  <option>5 matchs</option>
						</select>
						</div>
						</h3>
					</div>
					<div class="row">
						<h3>
						<div class="col-xs-3">If search keyword matches no promotion, send</div>
						<div class="col-xs-2"><select class="form-control">
						  <option>random promotion from list</option>
						  <option>just aisle directions, no promotion</option>
						  <option>3 matchs</option>
						  <option>4 matchs</option>
						  <option>5 matchs</option>
						</select>
