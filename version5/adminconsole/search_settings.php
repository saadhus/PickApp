  ...
  <body>
    ...
    <div id="wrapper">
          ...
          <ul class="nav navbar-nav side-nav">
			...
			<li class="dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li class="active"><a href="search_settings.php"><i class="fa fa-wrench"></i> Search Settings</a></li>
              </ul>
            </li>
			<li class="dropdown">
      ...
      <div id="page-wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h1>Search Settings <small>Change the settings for your search function</small></h1>
            <ol class="breadcrumb">
              <li><a href="dashboard.php"><i class="fa fa-dashboard"></i> Dashboard</a></li>
              <li class="active"><i class="fa fa-wrench"></i> Search Settings</li>
            </ol>
          </div>
        </div><!-- /.row -->
